  ...
  return (
    <div className={styles.page}>
      <div className={styles.pageHeader}>
        ...
        <Link href="/invoices/new" className={styles.primaryBtn}>
          + New Invoice
        </Link>
      </div>
              ...
              <tbody>
                {receivables.map(r => (
                  <tr key={r.customerId} className={r.isOverdue ? styles.rowOverdue : ""}>
                    <td>
                      <Link href={`/customers/${r.customerId}`} className={styles.customerLink}>
                        {r.customerName}
                      </Link>
                    ...
                    <td>
                      <Link href={`/invoices?customer=${r.customerId}`} className={styles.viewLink}>
                ...
                <tbody>
                  {overdueInvoices.map(inv => (
                    <tr key={inv.invoiceId}>
                      <td>
                        <Link href={`/invoices/${inv.invoiceId}`} className={styles.invLink}>
                          {inv.invoiceNumber}
                        </Link>
                      </td>
