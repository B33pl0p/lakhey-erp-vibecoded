    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.headerActions}>
          <Link href={`/quotations/${id}/print`} className={styles.printBtn} target="_blank">
            <Printer size={16} />
            Print / PDF
          </Link>
          {canEdit && (
          ...
          {quote.converted_order_id && (
            <Link href={`/orders/${quote.converted_order_id}`} className={styles.orderLink}>
              View Order →
            </Link>
          )}
        </div>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.card}>
          ...
          {customer ? (
            <>
              <Link href={`/customers/${customer.$id}`} className={styles.entityLink}>
                {customer.name}
              </Link>
