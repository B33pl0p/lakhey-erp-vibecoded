    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.headerActions}>
          ...
          <Link href={`/admin/orders/${id}/edit`} className={styles.editBtn}>
            <Edit2 size={16} />
            Edit
          </Link>
        </div>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.card}>
          ...
          {customer ? (
            <div className={styles.infoBlock}>
              <Link href={`/admin/customers/${customer.$id}`} className={styles.bigLink}>{customer.name}</Link>
        ...
        {order.is_product && (
          <div className={styles.card}>
            ...
            {product ? (
              <div className={styles.infoBlock}>
                <Link href={`/admin/products/${product.$id}`} className={styles.bigLink}>{product.name}</Link>
